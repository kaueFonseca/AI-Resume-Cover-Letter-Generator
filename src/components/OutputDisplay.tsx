  ...
  export default function OutputDisplay({ content, isLoading, error }: OutputDisplayProps) {
        ...
        return (
          <div className="p-6 space-y-8">
            <div>
              ...
              <div className="relative p-4 border rounded-lg bg-gray-50 whitespace-pre-wrap font-mono text-sm">
    ...
    return (
      <div className="w-full rounded-2xl border bg-card text-card-foreground shadow-lg">
